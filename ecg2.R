...
encoder %>% save_model_weights_tf(paste0("ecg_conv_encoder_", fnn_multiplier))
decoder %>% save_model_weights_tf(paste0("ecg_conv_decoder_", fnn_multiplier))

encoder %>% load_model_weights_tf(paste0("ecg_conv_encoder_", fnn_multiplier))
decoder %>% load_model_weights_tf(paste0("ecg_conv_decoder_", fnn_multiplier))
...
# 0.0280 0.00351  6.67e-5  6.14e-5  7.54e-5 5.32e-5 1.31e-4 7.64e-5 7.36e-5 1.49e-4
