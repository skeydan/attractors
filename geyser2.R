...
encoder %>% save_model_weights_tf(paste0("geyser_conv_encoder_", fnn_multiplier))
decoder %>% save_model_weights_tf(paste0("geyser_conv_decoder_", fnn_multiplier))

encoder %>% load_model_weights_tf(paste0("geyser_conv_encoder_", fnn_multiplier))
decoder %>% load_model_weights_tf(paste0("geyser_conv_decoder_", fnn_multiplier))
